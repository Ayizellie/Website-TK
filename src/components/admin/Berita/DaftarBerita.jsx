...
const FormBerita = ({ data, onSimpan, onBatal }) => {
  ...
  const handleSave = () => {
    if (!tagline || !isi || !foto) {
      Swal.fire("Error", "Isi semua field sebelum menyimpan!", "error");
      return;
    }
    onSimpan({ tagline, isi, foto });
  };
    ...
    <NavbarSidebar>
      <div className="pt-0 px-8 pb-8">
        ...
        <div className="mb-4">
            ...
            <div className="relative w-48 h-32 border-2 border-dashed border-gray-300 rounded-xl flex items-center justify-center cursor-pointer hover:border-blue-400 transition">
                {foto ? (
                <>
                    <img
                    src={foto}
                    ...
                    type="button"
                    onClick={(e) => {
                        e.stopPropagation(); // supaya klik tombol tidak memicu div utama
